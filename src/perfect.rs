...
pub async fn search_file(search: &str, path: &Path, file_extensions: &Vec<&str>) {
    println!("开始扫描文件");
...
pub fn scan_file<'a>(directory: PathBuf, file_path: &mut Vec<String>, file_extensions: &Vec<&str>) {
